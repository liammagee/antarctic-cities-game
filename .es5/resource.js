...
var res = {
    ...
    policy_dot_off_png: "res/png/BUTTONS/DOT_OFF.png",
    policy_dot_on_png: "res/png/niab/DOT_ON.png",
    quit_off_png: "res/png/niab/BUTTON_QUIT.png",
    quit_on_png: "res/png/niab/BUTTON_QUIT.png",
    pause_off_png: "res/png/niab/BUTTON_PAUSE_NORMAL.png",
    pause_on_png: "res/png/niab/BUTTON_PAUSE_ON.png",
    play_off_png: "res/png/niab/BUTTON_PLAY_NORMAL.png",
    play_on_png: "res/png/niab/BUTTON_PLAY_ON.png",
    playfast_off_png: "res/png/niab/BUTTON_PLAYFAST_NORMAL.png",
    playfast_on_png: "res/png/niab/BUTTON_PLAYFAST_ON.png",
    antarctica_small_png: "res/png/NEW_ICONS/ANTARCTICA_SMALL.png",
    antarctica_large_png: "res/png/NEW_ICONS/ANTARCTICA_LARGE.png",
    resource_icon: "res/png/NEW_ICONS/ICON_RESOURCE.png",
    resource_economy_1: "res/png/niab/ICON_RESOURCE_ECONOMY_1.png",
    resource_economy_2: "res/png/niab/ICON_RESOURCE_ECONOMY_2.png",
    resource_economy_3: "res/png/niab/ICON_RESOURCE_ECONOMY_3.png",
    resource_economy_4: "res/png/niab/ICON_RESOURCE_ECONOMY_4.png",
    resource_politics_1: "res/png/niab/ICON_RESOURCE_POLITICS_1.png",
    resource_politics_2: "res/png/niab/ICON_RESOURCE_POLITICS_2.png",
    resource_politics_3: "res/png/niab/ICON_RESOURCE_POLITICS_3.png",
    resource_politics_4: "res/png/niab/ICON_RESOURCE_POLITICS_4.png",
    resource_culture_1: "res/png/niab/ICON_RESOURCE_CULTURE_1.png",
    resource_culture_2: "res/png/niab/ICON_RESOURCE_CULTURE_2.png",
    resource_culture_3: "res/png/niab/ICON_RESOURCE_CULTURE_3.png",
    resource_culture_4: "res/png/niab/ICON_RESOURCE_CULTURE_4.png",
    resource_ecology_1: "res/png/niab/ICON_RESOURCE_ECOLOGY_1.png",
    resource_ecology_2: "res/png/niab/ICON_RESOURCE_ECOLOGY_2.png",
    resource_ecology_3: "res/png/niab/ICON_RESOURCE_ECOLOGY_3.png",
    resource_ecology_4: "res/png/niab/ICON_RESOURCE_ECOLOGY_4.png",
    button_white: "res/png/BUTTONS/BUTTON_WHITE.png",
    button_grey: "res/png/BUTTONS/BUTTON_GREY.png",
    progress_bar: "res/png/progress-bar.png",
    ctrls_background: "res/png/ctrls-background.png",
    status_button: "res/png/status-button.png",
