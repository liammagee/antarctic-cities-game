	...
	"esp": {
		...
		"messages": {
			"negative": [
				...
				"A nivel mundial, el aumento del nivel del mar cuesta a las ciudades costeras 1 billón de dólares al año.",
				...
				"El turismo en la Antártida alcanza el millón de visitantes al año!"
			],
			"positive": [
				"¡Por fin! El entorno físico de la Antártida y el Océano Austral está volviendo a los niveles de 2020...",
				"¡Hey Jude! Los niveles de ozono en la estratosfera antártica están volviendo a los valores de la década de 1960....",
				"La acidificación de los océanos ya no está aumentando drásticamente...",
				...
				"Comienza la conservación sistemática....",
				...
				"¡Eureka! Los científicos descubren nuevos compuestos de la biota antártica, con importantes aplicaciones industriales y médicas...."
			]
		}
